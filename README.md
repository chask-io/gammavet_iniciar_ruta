...
Inicia o reclama la parada indicada de una ruta de conductor Gammavet
...
- The function name matches "IniciarRutaFn"
...
- AWS CloudWatch Logs: `/aws/lambda/IniciarRutaFn`
- Chask dashboard: Organization → Functions → IniciarRutaFn
